 ...
 <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        ...
        <a class="navbar-brand brand-logo" href="index.html">     <img src="{{ asset('images/favicon.png') }}"  alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('images/favicon.png') }}" alt="logo"/></a>
      </div>
